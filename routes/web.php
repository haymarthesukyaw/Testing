...
// });
Auth::routes();
Route::get('/reset', 'PasswordController@ttt')->name('pwd.request');

Route::get('/login','User\UserController@showLoginForm');
...
// Route::group(['middleware' => 'auth'], function () {
    ...
    //User
    Route::get('/users','User\UserController@index')->name('index')->middleware('authenticated');
    //User Create
    ...
    //User Search
    Route::get('/users/search','User\UserController@search')->name('search');
